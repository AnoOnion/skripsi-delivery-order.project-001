        ...
        <div class="flex justify-center md:justify-start items-center w-full md:w-5/12 h-full">
            <div class="block space-y-4 pl-16 md:pl-24 pr-16 md:pr-32">
                <div class="block space-y-2">
                    ...
                    <p class="text-sm font-semibold text-slate-600">Kata sandi baru Anda harus berbeda dengan kata sandi yang digunakan sebelumnya.</p>
                </div>
...
<script>
    ...
    export default {
        ...
        beforeRouteEnter: async (to, from, next) => {
            await axios.post('/api/user/password/token', {
        ...
        setup() {
            ...
            const onReset = values => {
                ...
                axios.post('/api/user/password/reset', params).then(({ data }) => {
