        ...
        <div class="flex justify-center md:justify-start items-center w-full md:w-5/12 h-full">
            <div class="block space-y-4 pl-16 md:pl-24 pr-16 md:pr-32">
                <div class="block space-y-2">
                    <h2 class="text-lg font-bold">Topup Saldo Gagal</h2>
                    <p class="text-sm font-semibold text-slate-600">Maaf, sepertinya topup yang anda lakukan gagal, silahkan hubungi contact support untuk lebih detailnya.</p>
                </div>
            </div>
        </div>
    </div>
